...
#try:
 #   response = requests.get('https://gentai.instamart.ai:8444/get_upload_folder')
  #  response_data = response.json()
   # UPLOAD_FOLDER = response_data.get('upload_folder_path')
#except requests.RequestException as e:
 #   print(f"Error retrieving upload folder path: {e}")
